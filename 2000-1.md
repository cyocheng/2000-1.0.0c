...
H = 397885 * np.array([1, 0.0, 0.0])# external magnetic field (A/m)
...
```
    ...
    2018/09/12 19:05: Running OOMMF (paper-t100\paper-t100.mif) ... (9.9 s)
...
H =397885 * np.array([0.99995223636, 0.009773688199, 0.0]) # external magnetic field (A/m)
...
```
    ...
    2018/09/12 19:05: Running OOMMF (paper-t100\paper-t100.mif) ... (1350.1 s)
